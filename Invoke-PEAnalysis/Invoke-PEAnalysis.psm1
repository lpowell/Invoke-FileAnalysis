...
Function Ripper(){
    ...
    $SizeOfOptionalHeader = [System.Convert]::ToInt64([System.Convert]::ToHexString($SizeOfOptionalHeader),16)
        ...
        if($PEType -eq "PE32"){
            ...
            # # REMOVE
            # Write-Host "OPTIONAL HEADERS $([System.Convert]::ToHexString($OptionalHeaders))"
        ...
        for($i=0;$i -lt $Sections;$i++){
            ...
            if([System.Convert]::ToInt64($SectionsTableStrings[$i]["VirtualAddress"], 16) -lt [System.Convert]::ToInt64([System.Convert]::ToHexString($ImportTable[4..7]), 16) -And ([System.Convert]::ToInt64($SectionsTableStrings[$i]["VirtualAddress"], 16) + [System.Convert]::ToInt64([System.Convert]::ToHexString($SectionsTableStrings[$i]["VirtualSize"]), 16)) -gt [System.Convert]::ToInt64([System.Convert]::ToHexString($ImportTable[4..7]), 16)){
                ...
                # REMOVE
                # Write-Host "IDT SIZE $([System.Convert]::ToHexString($ImportTable[4..7]))"
                # Write-Host "IDT OFFSET $($IDTOffset)"
                # Write-Host "IDT SEEK $($IDTSeek)"
                # Write-Host "IDT RVA $($SectionsTableStrings[$i]["VirtualAddress"])"
        ...
        $ImportDLLNameArray= @()
            for($i=0;;$i++){
                ...
                # # REMOVE
                # Write-Host "IDTARRAY $([System.Convert]::ToHexString($IDTARRAY))"
                ...
                # # REMOVE CORRECT
                # Write-Host "DLL NAME RVA $([System.Convert]::ToHexString($ImportDirectoryTable[$i]["NameRVA"]))"
                ...
                # # REMOVE
                # Write-Host "ILT RVA $([System.Convert]::ToHexString($ImportDirectoryTable[$i]["ILTRVA"]))"
                ...
                # # REMOVE
                # Write-Host "ImportDLLARRAY $([System.Convert]::ToHexString($ImportDLLArray))"
                ...
                # # REMOVE ISSUE
                # Write-Host "IMPORTLOOKUPARRAY $([System.Convert]::ToHexString($ImportLookupArray))"
        ...
        if([System.Convert]::ToInt64([System.Convert]::ToHexString($CLRRuntimeHeader),16) -ne 0){
            ...
            $File.Read($NETHeaderArray, 0, [System.Convert]::ToInt64([System.Convert]::ToHexString($CLRRuntimeHeader[0..3]), 16)) | Out-Null
                ...
                # Write-Host "NETHEADER $([System.Convert]::ToHexString($NETHeaderArray))"
...
# Launch Output 
Export-ModuleMember -Function Invoke-PEAnalysis